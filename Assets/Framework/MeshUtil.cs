...
{
	internal static Mesh CreateQuad ( int width, int height, Color color )
	{
		return CreateQuad ( width, height, SpriteAlignment.Center, color, color, color, color );
	}

	internal static Mesh CreateQuad ( int width, int height, SpriteAlignment alignment, Color topLeftColor, Color topRightColor, Color bottomLeftColor, Color bottomRightColor )
	{
		Mesh mesh = new Mesh ();
		mesh.name = "Quad";
